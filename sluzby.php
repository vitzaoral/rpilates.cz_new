    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12 service-block animated" id="element-to-animate">
          ...
          <div class="row">
            <div class="col-md-offset-1 col-md-6 line service-desc">
              <h2><a href="#" class="service-title">Rehabilitace</a></h2>
              ...
              <a href="#" class="btn btn-default hvr-sweep-to-right">Zjistit více ></a>
            </div>
            <div class="col-md-5">
              <!-- service-pic-->
              <div class="service-img zoom-pic"> <a href="#"><img src="images/service-1.jpg" alt="" class="img-responsive"></a> </div>
            </div>
            <!-- service-pic-->
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-5">
              <div class="service-img zoom-pic">
                ...
                <a href="#"><img src="images/service-2.jpg" alt="" class="img-responsive"></a> </div>
            </div>
            <!-- /.service-pic-->
            <div class="col-md-offset-1 col-md-6 line-left service-desc">
              <h2><a href="#" class="service-title">Sportovní fyzioterapie</a></h2>
              ...
              <a href="#" class="btn btn-default hvr-sweep-to-right">Zjistit více ></a> </div>
          </div>
        </div>
        <!-- service block -->
        <div class="col-md-12 service-block">
          ...
          <div class="row">
            <div class="col-md-offset-1 col-md-6 line service-desc">
              <h2><a href="#" class="service-title">Masáže</a></h2>
            ...
            <div class="col-md-5">
              <!-- service-pic-->
              <div class="service-img zoom-pic"> <a href="#"><img src="images/service-3.jpg" alt="" class="img-responsive"></a> </div>
            </div>
            <!-- service-pic-->
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-5">
              <div class="service-img zoom-pic">
                ...
                <a href="#"><img src="images/service-4.jpg" alt="" class="img-responsive"></a> </div>
            </div>
            <!-- /.service-pic-->
            <div class="col-md-offset-1 col-md-6 line-left service-desc">
              <h2><a href="#" class="service-title">Skupinové zdravotní cvičení</a></h2>
        ...
        <div class="col-md-12 service-block">
          ...
          <div class="row">
            <div class="col-md-offset-1 col-md-6 line service-desc">
              <h2><a href="#" class="service-title">Pilates – jóga – powerjóga</a></h2>
            ...
            <div class="col-md-5">
              <!-- service-pic-->
              <div class="service-img zoom-pic"> <a href="#"><img src="images/service-5.jpg" alt="" class="img-responsive"></a> </div>
            </div>
            <!-- service-pic-->
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-5">
              <div class="service-img zoom-pic">
                ...
                <a href="#"><img src="images/service-6.jpg" alt="" class="img-responsive"></a> </div>
            </div>
            <!-- /.service-pic-->
            <div class="col-md-offset-1 col-md-6 line-left service-desc">
              <h2><a href="#" class="service-title">Poradenství – víkendové kurzy</a></h2>
